...
const zodBlog = z.object({
    title: z.string().min(5, "Title is required").max(50, "Title must be less than 50 characters"),
    ...
    category: z.enum(categories, {
        message: "Category must be one of the following: Technology, Health, Lifestyle, Education, Travel"
    })
})
